...
architecture arch of uc_jogo_reacao is
    ...
    type estados is (INICIAL, PREPARA, FALSO_ALARME, PREPARA2, ESTIMULA, MEDE, ERROR, FIM, ESPERA, PERDEU);
...
begin
    ...
    proximo_estado <= PREPARA      when (estado_atual = INICIAL      and jogar         = '1') else
                      ...
                      FALSO_ALARME when (estado_atual = PREPARA      and tem_falso     = '1' and passou_falso  = '1' and resposta      = '0' ) else
                      ESTIMULA     when (estado_atual = PREPARA      and tem_falso     = '0' and passou_rand   = '1' and resposta      = '0') else
