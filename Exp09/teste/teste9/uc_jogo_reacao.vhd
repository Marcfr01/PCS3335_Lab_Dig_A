...
-- NOVOS ESTADOS: RESPOSTA1, ACERTOU1, ERROU1, ESPERA1, RESPOSTA2, ACERTOU2, ERROU2, ESPERA2
    ...
    proximo_estado <= INICIAL  when (estado_atual = INICIAL and jogar     = '0') else
							 ...
							 ACERTOU1  when (estado_atual = RESPOSTA1 and acertou = '1' and passou05 = '1') else
							 ...
							 FIM       when (estado_atual = JOGA2   and fim2      = '1') else
							 ...
							 ACERTOU2  when (estado_atual = RESPOSTA2 and acertou = '1' and passou05 = '1') else
    ...
    ligado   <= '0' when (estado_atual = INICIAL) else '1';
	 ...
	 resetP1    <= '1' when (estado_atual = MUSICA1) else '0'; 
	 resetP2    <= '1' when (estado_atual = MUSICA2) else '0';
...
-- alem disso, ele fica apagado enquanto esta no estado de ESPERA (1 e 2)
	 ledar      <= '1' when (estado_atual = JOGA1 or estado_atual = RESPOSTA1 or estado_atual = ACERTOU1 or estado_atual = ERROU1 or estado_atual = ESPERA1) else
						'1' when (estado_atual = JOGA2 or estado_atual = RESPOSTA2 or estado_atual = ACERTOU2 or estado_atual = ERROU2 or estado_atual = ESPERA2) else
						'0';
